    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1">
                ...
                <div>
                    <img className="w-[80%] ml-[17%] mt-[100px] object-cover object-center h-[720px] w-[660px]" src={SportsCar_6 } alt="SportsCar_6 " />
                    <img className="w-[80%] ml-[45%] mt-[100px] object-cover object-center h-[720px] w-[660px]" src={SportsCar_7 } alt="SportsCar_7 " />
                </div>
