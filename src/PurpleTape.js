    ...
    return (
        <div className="flex flex-col min-h-screen">
            ...
            <main className="flex-1">
                ...
                <div className="w-full text-center px-[40%] py-0 mt-[10px] opacity-0 animate-fadeSlideUp delay-300" ref={mainRef}>
                ...
                <div>
                    <img className=" ml-[280px] mt-[100px] object-cover object-center h-[720px] w-[660px]" src={PurpleTape_6 } alt="PurpleTape_6 " />
